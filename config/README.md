...
- These are the minimum required vars need to setup to make RadhaX Music Bot functional.
...
8. `STRING_SESSION` : Pyrogram Session Needed, Generate string from [@RadhaXStringBot](http://t.me/RadhaXStringBot) in Telegram.
...
- You can play tracks or playlists from spotify from RadhaX Music bot
...
- If you plan to use RadhaX Music Bot with your own customized or modified code.
...
- You can change images which are used in RadhaX Music Bot.
- You can generate telegaph links from [@RadhaXTelegraphBot](http://t.me/RadhaXTelegraphBot) and use it here.
...
1. `STRING_SESSION2` : Pyrogram Session Needed, Generate string from [@RadhaXStringBot](http://t.me/RadhaXStringBot) in Telegram.
2. `STRING_SESSION3` : Pyrogram Session Needed, Generate string from [@RadhaXStringBot](http://t.me/RadhaXStringBot) in Telegram.
3. `STRING_SESSION4` : Pyrogram Session Needed, Generate string from [@RadhaXStringBot](http://t.me/RadhaXStringBot) in Telegram.
4. `STRING_SESSION5` : Pyrogram Session Needed, Generate string from [@RadhaXStringBot](http://t.me/RadhaXStringBot) in Telegram.
