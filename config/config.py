...
UPSTREAM_REPO = getenv(
    "UPSTREAM_REPO",
    "https://github.com/TeamRadhaX/RadhaXMusicBot",
)
...
)  # Example:- https://t.me/TheRadhaX
SUPPORT_GROUP = getenv(
    "SUPPORT_GROUP", None
)  # Example:- https://t.me/RadhaXSupport
...
# You'll need a Pyrogram String Session for these vars. Generate String from our session generator bot @RadhaXStringBot
