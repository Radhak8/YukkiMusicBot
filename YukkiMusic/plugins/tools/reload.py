...
from RadhaXMusic.utils.database import get_authuser_names, get_cmode
from RadhaXMusic.utils.decorators import (ActualAdminCB, AdminActual,
                                         language)
from RadhaXMusic.utils.formatters import alpha_to_int
...
async def restartbot(client, message: Message, _):
    ...
    try:
        db[message.chat.id] = []
        await RadhaX.stop_stream(message.chat.id)
    except:
        pass
