...
import config
from RadhaXMusic import Carbon, YouTube, app
from RadhaXMusic.core.call import RadhaX
from RadhaXMusic.misc import db
from RadhaXMusic.utils.database import (add_active_chat,
...
from RadhaXMusic.utils.inline.play import (stream_markup,
                                          telegram_markup)
from RadhaXMusic.utils.inline.playlist import close_markup
from RadhaXMusic.utils.pastebin import RadhaXbin
from RadhaXMusic.utils.stream.queue import put_queue, put_queue_index
...
async def stream(
    ...
    if forceplay:
        await RadhaX.force_stop_stream(chat_id)
